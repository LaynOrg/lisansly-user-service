...
func (m *MockService) Login(ctx context.Context, user *UserPayload) (*jwt_generator.Tokens, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Register(ctx context.Context, user *UserPayload) (*jwt_generator.Tokens, error) {
	m.ctrl.T.Helper()
